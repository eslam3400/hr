...
<form id="add-form" method="POST" style="direction:rtl">
    ...
    <div class="form-row">
        ...
        <div class="form-group col-md-<?php if (isset($_GET['action'])) echo '4';
                                        else echo '6' ?>">
            <label for="first-name">الاسم الاول</label>
            <input type="text" name="first-name" class="form-control" id="first-name" value="<?php if (isset($_GET['action']) && isset($first_name)) {
                                                                                                    echo $first_name;
                                                                                                } ?>" required>
        </div>
        <div class="form-group col-md-<?php if (isset($_GET['action'])) echo '4';
            ...
            <input type="text" name="last-name" class="form-control" id="last-name" value=" <?php if (isset($last_name)) {
                                                                                                echo $last_name;
                                                                                            } ?>" required>
        </div>
    ...
    <div class="form-row">
        <div class="form-group col-md-4">
            ...
            <input type="number" name="salary" class="form-control" id="salary" value="<?php if (isset($salary)) {
                                                                                            echo $salary;
                                                                                        } ?>" required>
        </div>
        ...
        <div class="form-group col-md-4">
            ...
            <input type="time" name="end-time" class="form-control" id="end-time" value="<?php if (isset($end_time)) {
                                                                                                echo $end_time;
                                                                                            } ?>" required>
        </div>
        <div class="form-group col-md-4">
            <label for="start-time">وقت بدايه العمل</label>
            <input type="time" name="start-time" class="form-control" id="start-time" value="<?php if (isset($start_time)) {
                                                                                                    echo $start_time;
                                                                                                } ?>" required>
        </div>
    </div>
    <div class="form-row mb-3">
        ...
        <div class="form-group col-md-6">
            ...
            <select class="mt-1" id="pranch" name="pranch">
                <option value="سبورتنج" <?php if (isset($pranch)) if ($pranch == 'سبورتنج') echo 'selected' ?>>سبورتنج</option>
    ...
    <?php
    if (isset($_GET['action'])) {
        if ($_GET['action'] == 'update') echo '<button type="submit" name="update-emp" class="btn btn-dark btn-block">
            <i class="fas fas fa-pen mr-2"></i> تحديث</button>';
    } else echo '<button type="submit" name="add-emp" class="btn btn-dark btn-block"><i class="fas fa-plus-circle mr-2"></i>
        اضافه</button>';

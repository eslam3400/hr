...
<div class="p-3">
    <?php $back_url = 'http://' . $_SERVER['SERVER_NAME'] . ':8080/hr/app/man-data.php';
...
<form id="add-form" method="POST" style="direction:rtl">
    ...
    <div class="form-row">
        <div class="form-group col-md-6">
            ...
            <input type="text" name="username" class="form-control" id="username" value="<?php if (isset($username)) {
                                                                                                echo $username;
                                                                                            } ?>" required>
        </div>
        <div class="form-group col-md-6">
            <label for="password">الباسورد</label>
            <input type="password" name="password" class="form-control" id="password" value="<?php if (isset($password)) {
                                                                                                    echo $password;
                                                                                                } ?>" required>
        </div>
    </div>
